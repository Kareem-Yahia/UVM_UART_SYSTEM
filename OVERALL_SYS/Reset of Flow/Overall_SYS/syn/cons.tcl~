...
set_dont_touch_network [get_clocks {REF_CLK1 UART_CLK1 ALU_CLK RX_CLK TX_CLK}]
...
set_clock_groups -asynchronous -group [get_clocks {REF_CLK1 ALU_CLK}] -group [get_clocks {UART_CLK1 RX_CLK TX_CLK}]
####################################################################################
           #########################################################
